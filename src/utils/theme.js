...
export function handleThemeStyle(themeStyle) {
  ...
  if (themeStyle === 'light') {
    Vue.prototype.$echartTheme = { bg: '#fff', fcp: '#333', fcs: '#666', fct: '#999', bcp: '#ccc', bcs: '#ddd', bct: '#eee', }
  } else if (themeStyle === 'dark') {
    Vue.prototype.$echartTheme = { bg: '#333', fcp: '#fff', fcs: 'rgba(255, 255, 255, 0.8)', fct: 'rgba(255, 255, 255, 0.6)', bcp: '#efefef', bcs: '#5d5d5d', bct: '#666', }
  }
